...
public class buscador {
	 ...
	 * @version 1.3
	 * @return Devuelve una posición dentro del array.
	 *@see CRUD ARRAY EJERCICIO IMF.
	 */
	
	public static int buscar(String[] lista, String dato) {

		int posicion = -1;	// Almacena la posición encontrada, se inicia a -1, si se produce ese resultado se interpreta como error.
